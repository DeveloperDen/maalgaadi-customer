...
const bookMG = require('../res/truck.png')
const favLoc = require('../res/fav_loc.png')
const notifications = require('../res/notification.png')
const rupee = require('../res/rupee.png')
const logout = require('../res/logout.png')
