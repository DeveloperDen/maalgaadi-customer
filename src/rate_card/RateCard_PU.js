...
export default class RateCard extends Component {
    ...
    constructor(props) {
        ...
        this.rates = [
            {
                type: 'Base Fare',
                value: `${String.fromCharCode(8377)} 450`,
                extras: ['Upto 4 Kms']
            },
            {
                type: 'Charges',
                value: `${String.fromCharCode(8377)} 31`,
                extras: ['Post 4 Kms']
            },
            {
                type: '*Loading',
                value: `${String.fromCharCode(8377)} 0`,
                extras: []
            },
            {
                type: '*Unloading',
            ...
            },
            {
                ...
                value: `${String.fromCharCode(8377)} 2.50`,
                extras: ['For waiting time', 'Per Minute'] 
            },
            {
                type: 'Drop Point Charges',
                value: `${String.fromCharCode(8377)} 35`,
                extras: ['After 2 drop points', 'Per Point'] 
            },
            {
                type: 'Hourly Charges',
                value: `${String.fromCharCode(8377)} 250`,
                extras: [] 
            },
